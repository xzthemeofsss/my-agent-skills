...
```bash
npx skills add xzthemeofsss/my-agent-skills --skill skillname
# or add all skills from the repo
npx skills add xzthemeofsss/my-agent-skills
```
...
```bash
git clone git@github.com:xzthemeofsss/my-agent-skills.git ~/temp-skills
```
